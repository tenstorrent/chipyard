...
#ifdef USE_RISCV_VECTOR
static inline _MMR_f64 randu_vector(long int * seed, int index ,unsigned long int gvl)
{
    /*
...
int main(int argc, char * argv[]){
    ...
    printf("Video sequence complete\n");
    ...
    printf("Particle filter complete\n");
